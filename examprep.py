...
def displayPDF(file):
    ...
    pdf_display = f'<iframe sandbox="allow-same-origin allow-downloads allow-popups allow-forms" src="data:application/pdf;base64,{base64_pdf}" width="700" height="1000" type="application/pdf"></iframe>'
    # Displaying File
